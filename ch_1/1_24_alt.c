/* program as requested, but not fully checked*/
/* there will be certain bugs, but it also now checks for esc sequences */
/* brief check shows parts that used to run fine (say, brackets) */
/* now stutter. just disregard this. */
#include <stdio.h>
#include <string.h>
